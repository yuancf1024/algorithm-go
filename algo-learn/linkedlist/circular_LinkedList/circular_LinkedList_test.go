...
// author: roseduan
// github: https://github.com/roseduan/algo-learn/blob/master/
// go/linkedlist/circular_linkedlist/circular_linkedlist_test.go
import (
	"fmt"
	"testing"
)
...
func TestLinkedList_Delete(t *testing.T) {
	...
	fmt.Println(*first) // 打印出节点结构体 {1 0xc0001180a8}
}